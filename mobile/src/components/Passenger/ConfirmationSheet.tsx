...
export const ConfirmationSheet: React.FC<Props> = ({
  translateY, fromAddress, toAddress, price, setPrice, onOrder, onEditAddress, onSwipeDown, loading
}) => {
        ...
        <View style={styles.expoMatteSheet}>
          ...
          <View style={styles.addressBox}>
            <TouchableOpacity style={styles.expoRow} onPress={onEditAddress}>
              ...
              <View style={styles.expoActionBtn}><Text style={styles.expoActionText}>Подъезд</Text></View>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.expoRow} onPress={onEditAddress}>
              ...
              <View style={styles.expoActionBtn}><Text style={styles.expoActionText}>＋</Text></View>
            </TouchableOpacity>
          </View>
...
const styles = StyleSheet.create({
  ...
  expoAddressText: { flex: 1, color: '#E4E4E7', fontSize: 15 },
