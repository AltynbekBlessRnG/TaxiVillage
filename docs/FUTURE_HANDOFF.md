...
## Обязательно в следующем обновлении Android

- Исправить иконку приложения: на установленном APK сейчас показывается стандартная Android-иконка.
- Проверить исходные изображения и нативную конфигурацию adaptive icon (`foreground`, `background`, `roundIcon`), а не только поле `expo.icon`.
- Включить исправление иконки в следующую общую сборку вместе с найденными UI-багами и нелогичностями; текущую сборку ради одной иконки не перезапускать.
